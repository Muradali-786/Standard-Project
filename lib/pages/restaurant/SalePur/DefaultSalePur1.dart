...
import 'package:com/pages/restaurant/SalePur/SalePurc1UI.dart';
...
class ResturantSalesPur1 extends StatefulWidget {
  final Map dropDownMap;
  final String menuName;
   final ItemSelectedCallback? onItemSelected;

  const ResturantSalesPur1({Key? key, this.onItemSelected, required this.dropDownMap, required this.menuName})
      : super(key: key);

  @override
  _ResturantSalesPur1State createState() => _ResturantSalesPur1State();
}

class _ResturantSalesPur1State extends State<ResturantSalesPur1> {
            ...
            child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    ...
                    print('...........length of new record is herereerererere......${newEntriesRecord.length}');
