...
class _SalePurItemUIState extends State<SalePurItemUI> {
  ...
  editList(){
    ...
    lisOpacityForEditNewEntries.clear();
    lisOpacityForCancelNewEntries.clear();
    lisOpacityForUpdateCheckNewEntries.clear();
    listCheckForEditNewEntries.clear();

    lisOpacityForEditModified.clear();
    lisOpacityForCancelModified.clear();
    lisOpacityForUpdateCheckModified.clear();
    listCheckForEditModified.clear();
