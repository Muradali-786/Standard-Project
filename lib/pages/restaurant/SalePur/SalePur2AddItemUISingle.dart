                        ...
                        FutureBuilder(
                          ...
                          builder: (BuildContext context,
                              ...
                              InkWell(
                                  ...
                                  child: Text(dropDownAccountNameMap['Title'] ==
                                          "Item Name"
                                      ? widget.accountName
                                      : dropDownAccountNameMap['Title'])),
                        ),
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                              ...
                              child: DropDownStyle1State.DropDownButton(
                                title:
                                    dropDownAccountNameMap['Title'].toString(),
                              ...
                              onChanged: (value) {
                                if (totalLock) {
                                  if (quantity_controller.text.length > 0) {
                                    ...
                                    if(price_controller.text.toString().length != 0) {
                                ...
                                onChanged: (value) {
                                  if (totalLock) {
                                    if (price_controller.text.length > 0) {
                                      double priceValue =
                                          double.parse(value.toString());
                                      if(quantity_controller.text.toString().length != 0) {
                      ...
                      InkWell(
                          onTap: () {
                            setState(() {
                              ...
                              chekIconForTotal = CupertinoIcons.textformat_123;
                              chekIconForPrice = CupertinoIcons.textformat_123;
                              quantityLock = true;
                              priceLock = false;
                              totalLock = false;
                            });
