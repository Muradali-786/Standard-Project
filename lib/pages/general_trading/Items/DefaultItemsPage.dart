...
import 'package:com/pages/general_trading/Items/rawMaterialPage.dart';
...
import 'ItemTreeView.dart';


class DefaultItemsPage extends StatefulWidget {
  final String menuName;

  const DefaultItemsPage({Key? key, required this.menuName}) : super(key: key);

  @override
  _DefaultItemsPageState createState() => _DefaultItemsPageState();
}

class _DefaultItemsPageState extends State<DefaultItemsPage> {
  String toDate =
                    ...
                    child: Align(
                      ...
                      child: PopupMenuButton<int>(
                        ...
                        onSelected: (value) async {
                          ...
                          if(value == 5){
                            List<Map> dataItemName = await _itemSql.dropDownDataForItemName();
                            ...
                            Navigator.push(context, MaterialPageRoute(builder:(context) =>  RawMaterialPage(map: dropDownMap,)));
                          }
                        },
                        itemBuilder: (context) {
                          return [
                            PopupMenuItem(value: 0, child: Text('Add New Item')),
                            PopupMenuItem(
                                enabled: false,
                                height: 20,
                                    ...
                                    return AlertDialog(
                                      ...
                                      content: Column(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: () async {
                                              List itemStockEdit = await _itemSql
                                                  .itemStockEdit(map['ItemID']);
                                              List list = [];
                                              list.add(map);
