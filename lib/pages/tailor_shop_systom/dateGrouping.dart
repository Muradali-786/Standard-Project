...
class TreeViewForTailor extends StatefulWidget {
  final List data;
  final Color color;
  final String date;
  ...
  @override
  State<TreeViewForTailor> createState() => _TreeViewForTailorState();
}

class _TreeViewForTailorState extends State<TreeViewForTailor> {
                    ...
                    (indexOFDay) => ExpansionTile(
                      ...
                      children: [
                        ListView.builder(
                          ...
                          itemCount: dataBilling.length,
                          itemBuilder: (context, index) => Padding(
                            padding: const EdgeInsets.only(top: 8.0),
                            child: InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => OrderDetailsPage(data: dataBilling[index]),));
                              },
                              child: Container(
                                width: MediaQuery.of(context).size.width,
                                              ...
                                              Row(
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                        'Order No: ${dataBilling[index]['TailorBooking1ID']}'),
                                                  ),
                                                  Text('${DateFormat(SharedPreferencesKeys.prefs!.getString(SharedPreferencesKeys.dateFormat)).format(DateTime(int.parse(dataBilling[index]['OrderDate'].toString().substring(0, 4)), int.parse(dataBilling[index]['OrderDate'].toString().substring(
                                                    5,
                                                    7,
                                                  )), int.parse(dataBilling[index]['OrderDate'].toString().substring(8, 10)))).toString()}'),
                                                ],
                                              ),
                                              Text(dataBilling[index]['CustomerName'].toString()),
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets.only(right: 4.0),
                                                    child: Text(
                                                      dataBilling[index]['TotalReceived']
                                                          .toString(),
                                                      style: TextStyle(
                                                        color: Colors.green,
                                                      ),
                                            ...
                                            menuBtnForOrderDetails(
                                              ...
                                              onTapFinished: () async {
                                                ...
                                                await dialogForChangeStatus(
                                                  ...
                                                  ID: dataBilling[index]['ID'].toString(),
                                                  orderDate: DateTime.now(),
                                                  dropDownDebitMap: dropDownDebitMap,
                                                );
                                              },
