...
Future<void> marriageImageSaveToLocal({
  ...
  var dir = Directory(
      '$appDocPath/ClientImages/${SharedPreferencesKeys.prefs!.getString('CountryName')}/${SharedPreferencesKeys.prefs!.getInt(SharedPreferencesKeys.clinetId)}/MarriageImages/$ID');
...
Future<void> renameMarriageFolderToLocal(
    {required String severID, required String localID}) async {
  Directory? appDocDir = await getExternalStorageDirectory();
  String appDocPath = appDocDir!.path;
  List listOfFolder = [];
  var dir = Directory(
      '$appDocPath/ClientImages/${SharedPreferencesKeys.prefs!.getString('CountryName')}/${SharedPreferencesKeys.prefs!.getInt(SharedPreferencesKeys.clinetId)}/MarriageImages');
  await dir.create(recursive: true);
...
Future<void> UploadMarriageImagesToServer(BuildContext context) async {
  Directory? appDocDir = await getExternalStorageDirectory();
  String appDocPath = appDocDir!.path;
  List listOfFolder = [];
  var dir = Directory(
...
Future<void> MarriageUpdateToServer(
    String image, String ID, String fileName) async {
  Uri url = Uri.parse(
  ...
  try {
    var response = await http.post(url, body: {
      'DisplayImage': image,
      'ImagePath':
      'ClientImages/${SharedPreferencesKeys.prefs!.getString('CountryName')}/${SharedPreferencesKeys.prefs!.getInt(SharedPreferencesKeys.clinetId)}/MarriageImages/$ID',
...
Future<List<File>> MarriageFileImages(String ID) async {
...
Future<List> allImages(String ID) async {
  ...
  while (true) {
    Uint8List? images =
    await tailorImagesFetching(fileName: '${i + 1}', ID: ID);
...
Future<Uint8List?> tailorImagesFetching({
  ...
  String imageUrl =
      'http://api.easysoftapp.com/PhpApi1/ClientImages/${SharedPreferencesKeys.prefs!.getString('CountryName')}/${SharedPreferencesKeys.prefs!.getInt(SharedPreferencesKeys.clinetId)}/MarriageImages/$ID/$fileName.jpg';
