...
class TokenOutSideClient extends StatefulWidget {
  final int? clientID;

  const TokenOutSideClient({
    super.key,
    this.clientID,
  });

  @override
  State<TokenOutSideClient> createState() => _TokenOutSideClientState();
}

class _TokenOutSideClientState extends State<TokenOutSideClient> {
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        country
                          ...
                          'CustomerName':
                              '${SharedPreferencesKeys.prefs!.getString(SharedPreferencesKeys.nameOfPerson)}',
                          'ClientID':
                              '${widget.clientID == null ? SharedPreferencesKeys.prefs!.getInt(SharedPreferencesKeys.clinetId)! : widget.clientID!}',
                          'ClientUserid':
                        ...
                        // bool insert = await addNewBillToServer(
                        //   context: context,
                        //     BeauticianID: beauticianID,
                        //     CustomerName:'${SharedPreferencesKeys.prefs!.getString(SharedPreferencesKeys.nameOfPerson)}',
                        //     CustomerMobileNo:'${SharedPreferencesKeys.prefs!.getString(SharedPreferencesKeys.mobileNumber)}',
                        ...
                        children: [
                          ...
                          Expanded(
                            child: FutureBuilder<List>(
                              future: getAllServicePriceListFromServer(
                                ...
                                if (snapshot.hasData) {
                                  if (snapshot.data!.length > 0) {
                                    if (listOFCheck.isEmpty) {
                                      ...
                                      totalServiceDuration  += double.parse(snapshot.data![0]['ServiceDuration'].toString().isEmpty ? '0' :snapshot.data![0]['ServiceDuration']);
                                                        ...
                                                        if (value) {
                                                          totalCharges += double.parse(
                                                              servicePriceControllersList[
                                                                  ...
                                                                  .text
                                                                  .toString());
                                                          totalServiceDuration  += double.parse(snapshot.data![index]['ServiceDuration'].toString().isEmpty ? '0' :snapshot.data![index]['ServiceDuration']);
                                                        } else {
                                                          ...
                                                          totalServiceDuration = totalServiceDuration -
                                                              double.parse(snapshot.data![index]['ServiceDuration'].toString().isEmpty ? '0' :snapshot.data![index]['ServiceDuration']);
                                                        }

                                                        print(totalServiceDuration.toString());
